...
public final class Canvas extends JPanel {
	...
	public void paint(Graphics g) {
		...
		synchronized (lines) {
			MyLineSegment line;
			MyCartesianCoordinate startPoint, endPoint;
	 ...
	 */
	public void drawLineBetweenPoints(MyCartesianCoordinate startPoint, MyCartesianCoordinate endPoint) {
		LineSegmentInColor line = new LineSegmentInColor(new MyLineSegment(startPoint, endPoint));
		synchronized (lines) {
			lines.add(line);
		}
		repaint();
	 ...
	 */
	public void drawLineBetweenPoints(MyCartesianCoordinate startPoint, MyCartesianCoordinate endPoint, Color color) {
		LineSegmentInColor line = new LineSegmentInColor(new MyLineSegment(startPoint, endPoint), color);
		synchronized (lines) {
			lines.add(line);
		}
		repaint();
	 ...
	 */
	public void drawLineSegment(MyLineSegment lineSegment) {
	 ...
	 * @param color       Color to use for line.
	 */
	public void drawLineSegment(MyLineSegment lineSegment, Color color) {
	 ...
	 */
	public void drawLineSegments(MyLineSegment[] lineSegments) {
		for (MyLineSegment thisLineSegment : lineSegments) {
	 ...
	 */
	public void drawLineSegments(MyLineSegment[] lineSegments, Color color) {
		for (MyLineSegment thisLineSegment : lineSegments) {
	...
	private final class LineSegmentInColor {
		private final MyLineSegment line;
		private final Color color;

		public LineSegmentInColor(MyLineSegment line) {
			this.line = line;
			this.color = DEFAULT_COLOR;
		}

		public LineSegmentInColor(MyLineSegment line, Color color) {
			this.line = line;
			this.color = color;
		}

		public MyLineSegment getLine() {
			return line;
		}
